...
description: "PRML Chapter 1.2.4"
date: 2025-04-28
---
...
<Callout variant="definition" title="Phân phối chuẩn">
...
<MdxImage
src="https://upload.wikimedia.org/wikipedia/commons/thumb/7/74/Normal_Distribution_PDF.svg/2560px-Normal_Distribution_PDF.svg.png" alt="im" caption="Hình 1: Đồ thị của phân phối chuẩn, có thể thấy đồ thị có dạng tháp chuông (nguồn: Wikipedia)" />
...
<Callout variant="note">
Việc phương sai mẫu $\sigma^2_{ML}$ tiến dần về phương sai thực sự $\sigma$ của phân phối khi mà $N \to \infty$ được chứng minh cụ thể ở **luật số lớn** [Law of Large Number](https://en.wikipedia.org/wiki/Law_of_large_numbers)
</Callout>
...
<Callout variant="warning"> Phần này optional, mình chứng minh chỉ để hiểu hơn thôi </Callout>
