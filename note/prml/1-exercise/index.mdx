...
Tìm xác suất $p(F = a)$ và $p(B = g \mid F = a)$.
</Question>
<Solution>
...
<Question>
Chứng minh rằng $\text{var}[f] = \mathbb{E}[f(X)^2] - \mathbb{E}[f(X)]^2$, dựa vào các tính chất sau của kì vọng ([MIT Expectation Slide](https://ocw.mit.edu/courses/6-042j-mathematics-for-computer-science-fall-2005/6ad0342f836f80c219470870db432c18_ln14.pdf)):
...
<Question>
Chứng minh rằng phân phối chuẩn $\mathcal{N}(\mu, \sigma^2)$ được chuẩn hoá (tức tích phân bằng $1$), bắt đầu từ tích phân $I = \int_{-\infty}^{\infty} \exp\left( -\frac{1}{2\sigma^2}x^2 \right)dx$.
</Question>
<Solution>
