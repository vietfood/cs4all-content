---
title: "Polynomial Curve Fitting (PRML)"
description: "PRML Chapter 1.1"
date: 2025-04-22
subject: "prml"
chapter: "1"
order: 1
...
<Callout variant="note">Bài toán dùng một giá trị đầu vào $$x$$ để dự đoán một giá trị số thực $$y$$ nào đó được gọi là bài toán **hồi quy** (regression).</Callout>
...
<Callout variant="note">Mặc dù $f(x, \mathbf{w})$ là một hàm không tuyến tính của $x$ nhưng lại là một hàm tuyến tính của $\mathbf{w}$, vì vậy ta có thể xem bài toán này là một bài toán **hồi quy tuyến tính** (linear regression) bởi vì đây là bài toán regression và ta dùng mô hình linear 🤯.</Callout>
...
<Callout variant="note"> Phần này mình nghĩ các bạn nên tự đọc, khá hay và nhiều insight, một phần vì mình cũng lười 😿. </Callout>